...
**feature mode:** search the API layer for files matching the feature name. Check project docs for API layout (`AGENTS.md`, root `README.md`, or conventions in `.claude/rules`); fall back to common patterns:
