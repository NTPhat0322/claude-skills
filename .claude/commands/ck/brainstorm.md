...
Read `.claude/skills/ck-brainstorm/SKILL.md` (project skill `ck-brainstorm`) and execute that workflow. Pass through any arguments the user provided: $ARGUMENTS
